...
| windows | `notable_runs` (P1) | pipeline output |
|---|---|---|
| 5 | 5 | 1 × `channel_pulse` (correct, informativeness 0.855) |
| 6 | 0 | **6 × `natural_holdout`** (informativeness 0.679 each) |
| 7 | 0 | **7 × `natural_holdout`** |
